...
document.querySelector('.contact-form').addEventListener('submit', async (e) => {
    ...
    const form = e.target;
    const formUrl = 'https://script.google.com/macros/s/AKfycbwO_g0EjNYbKh8XS4YsJbSAPXFRIm39hiFXxwoht5S21zDFTOjzhoy-xnjlwRCfB--d/exec'; // **<-- PASTE YOUR DEPLOYED WEB APP URL HERE**
